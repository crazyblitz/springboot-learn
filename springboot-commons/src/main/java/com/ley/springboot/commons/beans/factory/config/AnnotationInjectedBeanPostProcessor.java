package com.ley.springboot.commons.beans.factory.config;
...
import static com.ley.springboot.commons.utils.ClassUtils.resolveGenericType;
...
public abstract class AnnotationInjectedBeanPostProcessor<A extends Annotation> extends
    ...
    public AnnotationInjectedBeanPostProcessor() {
        this.annotationType = resolveGenericType(getClass(), 0);
    }
